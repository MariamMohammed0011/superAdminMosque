        ...
        <div className="flex flex-col items-center justify-center text-center p-20 gap-8 bg-white rounded-2xl xl:rounded-tr-none xl:rounded-br-none">
          ...
          <div className="flex flex-col text-2xl text-right gap-1 font-ruqaa">
            ...
            <input
              ...
              className={`rounded-md p-1 border-2 outline-none focus:border-[#AFD1BC] focus:bg-[#EBF3EC] ${shakeFields.email ? 'shake' : ''}`}
            />
          </div>
          ...
          <div className="flex flex-col text-2xl text-right gap-1 font-ruqaa">
            ...
            <input
              ...
              onChange={handleChange}
              className={`rounded-md p-1 border-2 outline-none focus:border-[#AFD1BC] focus:bg-[#EBF3EC] ${shakeFields.password ? 'shake' : ''}`}
            />
            ...
            <div className="flex gap-1 items-center flex-row-reverse py-6">
              ...
              />
              <span className="text-base px-1 text-[#2A603F]">تذكر البريد الإلكتروني</span>
            </div>
          </div>
